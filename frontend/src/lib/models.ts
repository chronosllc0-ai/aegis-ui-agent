...
export const PROVIDERS: ProviderInfo[] = [
  // ── Chronos Gateway ─────────────────────────────────────────────────
  {
    ...
    models: [
      ...
      { id: 'google/gemini-2.5-pro', label: 'Gemini 2.5 Pro', description: 'Best Gemini — complex reasoning & multimodal', vision: true, reasoning: true, contextLength: 1_048_576 },
  ...
  // ── OpenRouter ──────────────────────────────────────────────────────
  {
    ...
    models: [
      ...
      { id: 'google/gemini-2.5-pro', label: 'Gemini 2.5 Pro', description: 'Google flagship — complex reasoning, 1M context.', vision: true, reasoning: true, contextLength: 1_048_576 },
