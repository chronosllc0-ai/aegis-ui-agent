...
export type ModelInfo = {
  ...
  /**
   * Configurable effort values this exact provider/model accepts.
   * Always omit `none`; helper functions add Off automatically.
   * Some native-thinking models (for example Fireworks Kimi K2.5)
   * can reason but do not expose a supported effort knob.
   */
  reasoningEfforts?: readonly Exclude<ReasoningEffortLevel, 'none'>[]
...
export const REASONING_OFF_ONLY: readonly ReasoningEffortLevel[] = ['none']
export const OPENAI_GPT5_REASONING_EFFORTS: readonly Exclude<ReasoningEffortLevel, 'none'>[] = ['minimal', 'low', 'medium', 'high']
export const STANDARD_REASONING_EFFORTS: readonly Exclude<ReasoningEffortLevel, 'none'>[] = ['low', 'medium', 'high']
...
export const PROVIDERS: ProviderInfo[] = [
  // ── Chronos Gateway ─────────────────────────────────────────────────
  {
    ...
    models: [
      ...
      { id: 'openai/gpt-5.4', label: 'GPT-5.4', description: "OpenAI's latest frontier model", vision: true, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 1_048_576 },
      { id: 'openai/gpt-5.4-mini', label: 'GPT-5.4 Mini', description: 'Fast, cost-efficient GPT-5.4', vision: true, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 400_000 },
      { id: 'openai/gpt-5.4-nano', label: 'GPT-5.4 Nano', description: 'Lightest GPT-5.4 variant', vision: true, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 400_000 },
      { id: 'openai/gpt-5.3-codex', label: 'GPT-5.3 Codex', description: 'Best agentic coding model', vision: false, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 400_000 },
      ...
      { id: 'google/gemini-3.1-pro-preview', label: 'Gemini 3.1 Pro', description: 'Best Gemini with tool accuracy', vision: true, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 1_048_576 },
      { id: 'qwen/qwen3-max-thinking', label: 'Qwen3 Max Thinking', description: 'Flagship reasoning from Qwen3', vision: false, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 262_144 },
      ...
      { id: 'qwen/qwen3-coder:free', label: 'Qwen3 Coder (Free)', description: 'Free Qwen3 Coder model tuned for coding workloads.', vision: false, contextLength: 262_000 },
  ...
  // ── Google ──────────────────────────────────────────────────────────
  {
    ...
    keyPrefix: '',
    models: [
      { id: 'gemini-3.1-pro-preview', label: 'Gemini 3.1 Pro Preview', description: 'Latest Gemini 3 series - cutting-edge reasoning & multimodal.', vision: true, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 2_000_000 },
      ...
      { id: 'gemini-2.5-pro', label: 'Gemini 2.5 Pro', description: 'Stable production model - best quality + complex reasoning.', vision: true, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 1_048_576 },
      { id: 'gemini-2.5-flash', label: 'Gemini 2.5 Flash', description: 'Stable production model - fast responses, lower latency.', vision: true, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 1_048_576 },
    ],
  },
  // ── OpenAI ──────────────────────────────────────────────────────────
  {
    ...
    keyPrefix: 'sk-',
    models: [
      { id: 'gpt-5.2', label: 'GPT-5.2', description: 'Flagship - best for coding and agentic tasks.', vision: true, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 256_000 },
      { id: 'gpt-5.2-pro', label: 'GPT-5.2 Pro', description: 'Smarter, more precise responses on complex tasks.', vision: true, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 256_000 },
      { id: 'gpt-5', label: 'GPT-5', description: 'Intelligent reasoning model with configurable effort.', vision: true, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 256_000 },
      { id: 'gpt-5-mini', label: 'GPT-5 Mini', description: 'Fast, cost-efficient version of GPT-5.', vision: true, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 256_000 },
      { id: 'gpt-5-nano', label: 'GPT-5 Nano', description: 'Fastest, most cost-efficient GPT-5 variant.', vision: true, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 128_000 },
      ...
      { id: 'o4-mini', label: 'o4-mini', description: 'Advanced reasoning, compact.', vision: true, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 200_000 },
      { id: 'o3', label: 'o3', description: 'Deep reasoning model.', vision: true, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 200_000 },
    ],
  },
  // ── Anthropic ───────────────────────────────────────────────────────
  {
    ...
    keyPrefix: 'sk-ant-',
    models: [
      { id: 'claude-opus-4-6', label: 'Claude Opus 4.6', description: 'Most intelligent - agents and coding. 1M context.', vision: true, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 1_000_000 },
      { id: 'claude-sonnet-4-6', label: 'Claude Sonnet 4.6', description: 'Best combo of speed + intelligence. 1M context.', vision: true, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 1_000_000 },
      { id: 'claude-haiku-4-5', label: 'Claude Haiku 4.5', description: 'Fastest Anthropic model - near-frontier intelligence.', vision: true, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 200_000 },
      { id: 'claude-sonnet-4-20250514', label: 'Claude Sonnet 4', description: 'Previous generation balanced model.', vision: true, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 200_000 },
  ...
  // ── xAI ─────────────────────────────────────────────────────────────
  {
    ...
    models: [
      ...
      { id: 'grok-3-mini', label: 'Grok 3 Mini', description: 'Efficient, cost-effective Grok 3 variant.', vision: false, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 131_072 },
      { id: 'grok-3-mini-fast', label: 'Grok 3 Mini Fast', description: 'Ultra-fast variant of Grok 3 Mini.', vision: false, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 131_072 },
  ...
  // ── Fireworks AI ────────────────────────────────────────────────────
  {
    ...
    keyPrefix: '',
    models: [
      { id: 'accounts/fireworks/models/kimi-k2p5', label: 'Kimi K2.5', description: 'Moonshot AI Kimi K2.5 with native reasoning via Fireworks AI; Fireworks does not expose a supported effort selector for this model.', vision: false, reasoning: true, reasoningEfforts: [], contextLength: 262_144 },
  ...
  // ── OpenRouter ──────────────────────────────────────────────────────
  {
    ...
    keyPrefix: 'sk-or-',
    models: [
      { id: 'openai/gpt-5.4-pro', label: 'GPT-5.4 Pro', description: "OpenAI's most advanced model via OpenRouter.", vision: true, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 1_048_576 },
      { id: 'openai/gpt-5.4', label: 'GPT-5.4', description: "OpenAI's latest frontier model - unifying Codex and GPT lines.", vision: true, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 1_048_576 },
      { id: 'openai/gpt-5.4-mini', label: 'GPT-5.4 Mini', description: 'Faster, cost-efficient GPT-5.4 variant.', vision: true, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 400_000 },
      { id: 'openai/gpt-5.4-nano', label: 'GPT-5.4 Nano', description: 'Most lightweight and cost-efficient GPT-5.4 variant.', vision: true, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 400_000 },
      { id: 'openai/gpt-5.3-codex', label: 'GPT-5.3 Codex', description: "OpenAI's most advanced agentic coding model.", vision: false, reasoning: true, reasoningEfforts: OPENAI_GPT5_REASONING_EFFORTS, contextLength: 400_000 },
      ...
      { id: 'qwen/qwen3-max-thinking', label: 'Qwen3 Max Thinking', description: 'Flagship reasoning model in the Qwen3 series.', vision: false, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 262_144 },
      ...
      { id: 'google/gemini-3.1-pro-preview', label: 'Gemini 3.1 Pro', description: 'Google flagship - complex reasoning, 1M context.', vision: true, reasoning: true, reasoningEfforts: STANDARD_REASONING_EFFORTS, contextLength: 1_048_576 },
...
export function modelInfoForProvider(providerId: string, modelId: string): ModelInfo | undefined {
  const provider = providerById(providerId)
  return provider?.models.find((m) => m.id === modelId) ?? modelInfo(modelId)
}

export function supportedReasoningEffortsForModel(providerId: string, modelId: string): readonly ReasoningEffortLevel[] {
  const model = modelInfoForProvider(providerId, modelId)
  if (!model?.reasoning) return REASONING_OFF_ONLY
  const efforts = model.reasoningEfforts ?? []
  return ['none', ...efforts]
}

export function supportsConfigurableReasoning(providerId: string, modelId: string): boolean {
  return supportedReasoningEffortsForModel(providerId, modelId).some((effort) => effort !== 'none')
}
...
export function clampReasoningEffort(
  ...
  const normalized = String(requested ?? '').trim().toLowerCase().replace('extra_high', 'xhigh').replace('x-high', 'xhigh')
  const effort = normalized === 'off' || normalized === 'false' || normalized === '0'
    ? 'none'
    : normalized === 'on' || normalized === 'true' || normalized === '1' || normalized === 'adaptive'
      ? 'medium'
      : normalized === 'extended'
        ? 'xhigh'
        : normalized
  const supported = supportedReasoningEffortsForModel(providerId, modelId)
  if ((supported as readonly string[]).includes(effort)) return effort as ReasoningEffortLevel
  if (effort === 'xhigh' && (supported as readonly string[]).includes('high')) return 'high'
  if (effort === 'minimal' && (supported as readonly string[]).includes('low')) return 'low'
  if ((supported as readonly string[]).includes('medium')) return 'medium'
  if ((supported as readonly string[]).includes('low')) return 'low'
  return 'none'
}
