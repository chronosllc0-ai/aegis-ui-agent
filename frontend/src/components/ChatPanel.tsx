...
import { FaBrain, FaLaptopCode, FaSliders } from 'react-icons/fa6'
      ...
      <div className='overflow-hidden rounded-3xl border border-[#303030] bg-[#1a1a1a] shadow-[0_8px_30px_rgba(0,0,0,0.3)]'>
        ...
        <div className='relative'>
          <textarea
            ...
            style={{ minHeight: isExpanded ? '56px' : '46px', maxHeight: '160px', overflow: 'hidden' }}
          />
        </div>

        <div className='space-y-1 border-t border-[#242424] px-2.5 py-1.5'>
          <SuggestionChips onSelectSuggestion={onSelectSuggestion} onOpenGallery={onOpenGallery} />

          <div className='flex items-center gap-1 overflow-x-auto text-xs text-zinc-400'>
            <button type='button' onClick={onPlusClick} disabled={isDisabled}
              className='flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-md text-zinc-500 hover:bg-[#2a2a2a] hover:text-zinc-200 disabled:opacity-40 transition-colors'
            ...
            <label className='group relative inline-flex min-w-0 max-w-full items-center gap-1 rounded px-1 py-0.5 hover:bg-[#222]'>
              <FaLaptopCode className='h-3.5 w-3.5 text-zinc-400' />
              <select
                value={provider}
            ...
            <label className='group relative inline-flex min-w-0 max-w-full items-center gap-1 rounded px-1 py-0.5 hover:bg-[#222]'>
              <FaBrain className='h-3.5 w-3.5 text-zinc-400' />
              <select
                value={model}
            ...
            <label className='group relative inline-flex min-w-0 max-w-full items-center gap-1 rounded px-1 py-0.5 hover:bg-[#222]'>
              <FaSliders className='h-3.5 w-3.5 text-zinc-400' />
              <select
                value={agentMode}
            ...
            {isWorking && !canSend ? (
              <button type='button' onClick={onStop}
                className='flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-[#2a2a2a] text-red-300 hover:bg-[#333] transition-colors'
              ...
              <button type='button' onClick={onSend}
                ...
                className='flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-zinc-200 text-zinc-900 hover:bg-white disabled:opacity-30 disabled:cursor-not-allowed transition-colors'
